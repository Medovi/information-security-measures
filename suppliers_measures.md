...
<table>
    ...
    <tbody style="font-size: 12px;">
        ...
        <tr>
            ...
            <td>Команда.</td>
            <td>ИАФ.1<br>ИАФ.3<br>ИАФ.4<br>ИАФ.5</td>
            <td>УБИ.008<br>УБИ.030</td>
            <td>passwd(1, 8)</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody style="font-size: 12px;">
        ...
        <tr>
            <td>7.</td>
            <td>/usr/bin/samba-tool user<br>/usr/bin/samba-tool group</td>
            <td>Управление идентификаторами (учётными записями) и группами пользователей.</td>
            <td>Командный.</td>
            <td></td>
            <td></td>
            <td>samba-tool(8)</td>
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            <td>1.</td>
            <td>/etc/pam.d/system-auth-local-only<br>/etc/pam.d/system-auth-common</td>
            <td>Устанавливает необходимость применения парольной политики.</td>
            <td>Конфигурационные файлы.</td>
            <td>ИАФ.4</td>
            <td>УБИ.030<br>ИАФ.074<br>ИАФ.086<br>ИАФ.100<br>ИАФ.152</td>
            <td>pam(8)</td>
        </tr>
        <tr>
            <td>2.</td>
            <td>/usr/lib64/security/*</td>
            <td>Реализация политик аутентификации.</td>
            <td>Разделяемые библиотеки.</td>
            <td>ИАФ.4</td>
            <td>УБИ.030<br>УБИ.074<br>УБИ.086<br>УБИ.100<br>УБИ.152</td>
            <td>pam(8)<br>pam_u2f(8)</td>
        </tr>
        <tr>
            <td>3.</td>
            <td>/etc/passwdqc.conf<br>/etc/security/pwquality.conf</td>
            <td>Устанавливает строгость парольных политик.</td>
            <td>Конфигурационные файлы.</td>
            <td>ИАФ.4</td>
            <td>УБИ.030<br>УБИ.074<br>УБИ.086<br>УБИ.100<br>УБИ.152</td>
            <td>passwdqc.conf(5)<br><a href="https://docs.altlinux.org/ru-RU/alt-server/10.2/html/alt-server/passwdqc.html">Настройка парольных ограничений</a><br>pwquality.conf(5)</td>
        </tr>
        <tr>
            <td>4. </td>
            <td>/usr/bin/samba-tool domain passwordsettings pso</td>
            <td>Позволяет применить парольную политику к пользователям или группам пользователей.</td>
            <td>Команда</td>
            <td></td>
            <td></td>
            <td>samba-tool(8)<br><a href="https://docs.altlinux.org/ru-RU/domain/10.4/html/alt-domain/ch40s02s02.html">Управление парольными политиками при помощи samba-tool</a></td>
        </tr>
        <tr>
            <td>5.</td>
            <td>/usr/bin/passwd</td>
            <td>Установка/Изменение пароля в т.ч. начального.</td>
            <td>Команда.</td>
            <td>ИАФ.1<br>ИАФ.3<br>ИАФ.4<br>ИАФ.5</td>
            <td>УБИ.008<br>УБИ.030</td>
            <td>passwd(1, 8)</td>
        ...
        <tr>
            <td>6.</td>
            <td>/usr/sbin/useradd<br>/usr/sbin/usermod</td>
            <td>Создание пользователя, генерация начального пароля, блокировка, сброс и изменение параметров учётной записи пользователя.</td>
            <td>Команды.</td>
            <td>ИАФ.3<br>ИАФ.4<br>УПД.5</td>
            <td>УБИ.030<br>УБИ.086<br>УБИ.090</td>
            <td>useradd(8)<br>usermod(8)</td>
        ...
        <tr>
            <td>7.</td>
            <td>/usr/bin/chage</td>
            <td>Установка сроков действия пароля, принудительная смена.</td>
            <td>Команда.</td>
            <td>ИАФ.3<br>ИАФ.4</td>
            <td>УБИ.030<br>УБИ.086<br>УБИ.090</td>
            <td>chage(1)</td>
        ...
        <tr>
            <td>8.</td>
            <td>/etc/login.defs</td>
            <td>Значения по умолчанию для сроков действия и блокировки паролей.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>login.defs(5)</td>
        ...
        <tr>
            <td>9.</td>
            <td>/etc/shadow<br>/etc/shadow-<br>/etc/tcb/[user]/shadow<br>/etc/gshadow<br>/etc/gshadow-</td>
            <td>Защищённые хранилища хэшей паролей.</td>
        ...
        <tr>
            <td>10.</td>
            <td>/usr/lib64/security/pam_pwhistory.so</td>
            <td>Позволяет настроить запрет повторного использования старых паролей.</td>
            <td>Модуль PAM.</td>
            <td></td>
            <td></td>
            <td>pam_pwhistory(8)</td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            <td>1.</td>
            <td>/usr/bin/ls<br>/usr/bin/chmod<br>/usr/bin/chown<br>/usr/bin/chgrp<br>umask</td>
            <td>Отображает или назначает права доступа POSIX (в т.ч. с помощью маски прав, используемой по умолчанию).</td>
            <td>Команды.</td>
            <td>УПД.2<br>УПД.4<br>УПД.5<br>ЗИС.1</td>
            <td>УБИ.015<br>УБИ.067<br>УБИ.074<br>УБИ.078<br>УБИ.080<br>УБИ.084</td>
            <td>ls(1)<br>chmod(1)<br>chown(1)<br>chgrp(1)<br>umask(1)</td>
        </tr>
        <tr>
            <td>2.</td>
            <td>/usr/bin/getfacl<br>/usr/bin/setfacl</td>
            <td>Отображает или форматирует списки контроля доступа (ACL) POSIX.1e (в т.ч. с помощью маски прав, используемой по умолчанию).</td>
            <td>Команды.</td>
            <td>УПД.2<br>УПД.4<br>УПД.5</td>
            <td>УБИ.015<br>УБИ.067<br>УБИ.074<br>УБИ.078<br>УБИ.080<br>УБИ.084</td>
            <td>getfacl(1)<br>setfacl(1)<br>acl(5)</td>
        </tr>
        <tr>
            <td>3.</td>
            <td>/sbin/getcap<br>/sbin/setcap</td>
            <td>Отображает или формирует мандаты разрешений (capabilities).</td>
            <td>Команды</td>
            <td>УПД.2<br>УПД.4</td>
            <td>УБИ.015<br>УБИ.067<br>УБИ.074<br>УБИ.078<br>УБИ.080<br>УБИ.084</td>
            <td>capabilities(7)<br>prctl(2)</td>
        </tr>
        <tr>
            <td>4.</td>
            <td>access()<br>chmod()<br>chown()<br>prctl()<br>umask()</td>
            <td>Интерфейсы с функциями монитора обращений ядра ОС.</td>
            <td>Интерфейсы ядра (системные вызовы).</td>
            <td>УПД.2<br>УПД.4<br>УПД.5<br>ЗИС.1</td>
            <td>УБИ.015<br>УБИ.067<br>УБИ.074<br>УБИ.078<br>УБИ.080<br>УБИ.084</td>
            <td>access(2)<br>chmod(2)<br>chown(2)<br>prctl(2)<br>umask(2)</td>
        </tr>
        <tr>
            <td>5.</td>
            <td>/usr/bin/samba-tool</td>
            <td>Позволяет управлять пользователями, группами, правами и политиками безопасности AD через CLI.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>samba-tool(8)</td>
        ...
        <tr>
            <td>6.</td>
            <td>/usr/bin/wbinfo</td>
            <td>Позволяет получать SID, UID, GID и проверять привязку к AD (через winbind).</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>wbinfo(1)</td>
        ...
        <tr>
            ...
            <td>Позволяет получать информацию о пользователях и группах из домена через NSS.</td>
            <td>Команда</td>
            <td></td>
            <td></td>
            <td>getent(1)</td>
        ...
        <tr>
            <td>8.</td>
            <td>/usr/bin/setfacl<br>/usr/bin/getfacl</td>
            <td>Позволяет назначить расширенные права доступа (ACL) доменным субъектам.</td>
            <td>Команды.</td>
            <td></td>
            <td></td>
            <td>setfaclt(1)<br>getfacl(1)</td>
        </tr>
        <tr>
            <td>9.</td>
            <td>/usr/bin/net</td>
            <td>Позволяет настраивать, диагностировать и управлять подключением к AD (через winbind).</td>
            <td>Команда</td>
            <td></td>
            <td></td>
            <td>net(8)</td>
        ...
        <tr>
            ...
            <td>Основной конфигурационный файл Samba (пределяет домен и соответствующие настройки).</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>smb.conf(5)</td>
        ...
        <tr>
            <td>11.</td>
            <td>/etc/krb5.conf</td>
            <td>Настройка kerberos (realm, серверы).</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>krb5.conf(5)</td>
        ...
        <tr>
            ...
            <td>Подключение к системным источникам пользователей/групп (passwd, group, shadow).</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>nsswitch.conf(5)</td>
        </tr>
        <tr>
            <td>13.</td>
            <td>/etc/sssd/sssd.conf</td>
            <td>Конфигурация демона SSSD для получения данных из AD через LDAP/Kerberos.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>sssd.conf(5)</td>
        ...
        <tr>
            <td>14.</td>
            <td>/etc/security/pam_winbind.conf</td>
            <td>Параметры для PAM-модуля pam_winbind.so (если используется winbind).</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>pam_winbind.conf(5)</td>
        </tr>
        <tr>
            <td>15.</td>
            <td>/lib64/security/pam_winbind.so<br>/lib64/security/pam_sss.so</td>
            <td>PAM-модули для аутентификации доменных пользователей.</td>
            <td>Разделяемые библиотеки.</td>
            <td></td>
            <td></td>
            <td>pam_winbind(8)<br>pam_sss(8)</td>
        </tr>
        <tr>
            <td>16.</td>
            <td>/usr/bin/chmod<br>/usr/bin/chown<br>/usr/bin/ls<br>umask</td>
            <td>Назначение и просмотр POSIX-прав (в т.ч. доменным субъектам).</td>
            <td>Команды.</td>
            <td></td>
            <td></td>
            <td>chmod(1)<br>chown(1)<br>ls(1)<br>umask(1)</td>
        </tr>
        <tr>
            <td>17.</td>
            <td>/sbin/setcap<br>/sbin/getcap</td>
            <td>Назначение и просмотр capabilities.</td>
            <td>Команды.</td>
            <td></td>
            <td></td>
            <td>setcap(8)<br>getcap(8)</td>
        </tr>
    </tbody>
</table>
...
<table>
    <thead style="font-weight: bold; font-size: 12px;">
        <tr>
            <td>Десятичная<br>запись</td>
            <td>Двоичная<br>запись</td>
            <td>Маска</td>
            <td>Права на<br>файл</td>
            <td>Права на<br>каталог</td>
        </tr>
    </thead>
    <tbody style="font-size: 12px;">
        <tr>
        ...
        <tr>
            ...
            <td>001</td>
            <td>--x</td>
            <td>Право на выполнение</td>
            <td>Право на доступ к объектам и их метаданным</td>
        </tr>
        <tr>
            <td>2</td>
            <td>010</td>
            <td>-w-</td>
            <td>Право на запись</td>
            <td>Права отсутствуют</td>
        </tr>
        <tr>
            <td>3</td>
            ...
            <td>Все права кроме доступа к именам объектов</td>
        </tr>
        <tr>
            <td>4</td>
            <td>100</td>
            <td>r--</td>
            <td>Право на чтение</td>
            <td>Только чтение имён файлов</td>
        </tr>
        <tr>
            <td>5</td>
            <td>101</td>
            ...
            <td>Права на чтение имён объектов и доступ к объектам и их атрибутам</td>
        </tr>
        <tr>
            <td>6</td>
            <td>110</td>
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            <td>1.</td>
            <td>/sbin/iptables<br>/usr/sbin/nft</td>
            <td>Утилита настройки фильтрации и маршрутизации сетевых пакетов (nft является заменой ifconfig).</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>iptables(8)</td>
        ...
        <tr>
            <td>2.</td>
            <td>/sbin/ip</td>
            <td>Утилита для управления маршрутами, интерфейсами и правилами маршрутизации.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>ip(8)</td>
        ...
        <tr>
            <td>3.</td>
            <td>/usr/bin/tcpdump</td>
            <td>Анализатор сетевого трафика (или сниффер), позволяет сохранять сетевые пакеты для анализа.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>tcpdump(8)</td>
        ...
        <tr>
            <td>4.</td>
            <td>/usr/sbin/snort<br>/etc/snort/*</td>
            <td>Система обнаружения и предотвращения вторжений (IDS/IPS).</td>
            <td>Команда и конфигурационные файлы программы.</td>
            <td></td>
            <td></td>
            <td>snort(8)</td>
        </tr>
        <tr>
            <td>5.</td>
            <td>/usr/bin/suricata<br>/etc/suricata</td>
            <td>Система обнаружения и предотвращения вторжений (IDS/IPS).</td>
            <td>Команда и конфигурационные файлы программы.</td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>6.</td>
            <td>/etc/hosts.allow<br>/etc/hosts.deny</td>
            <td>Файлы управления доступом/запретом для TCP-соединений.</td>
            <td>Конфигурационные файлы.</td>
            <td></td>
            <td></td>
            <td>hosts(5)</td>
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            <td>1.</td>
            <td>/etc/pam.d/*<br>/etc/security/faillock.conf</td>
            <td>Интерфейс создания и проверки пароля по алгоритму ГОСТ Р 34.11-2012.</td>
            <td>Конфигурационные файлы.</td>
            <td>ИАФ.7</td>
            <td>УБИ.074</td>
            <td>faillock(8)<br>pam_faillock(8)<br><a href="https://docs.altlinux.org/ru-RU/alt-workstation/10.4/html/alt-workstation/hash_pass.html">Задание хешей паролей в соответствии с ГОСТ 34.11-2012</a></td>
        </tr>
        <tr>
            <td>2. </td>
            <td>/usr/bin/samba-tool domain passwordsettings pso</td>
            <td>Позволяет применить парольную политику к пользователям или группам пользователей.<br>Позволяет настроить блокирование доступа при первышении числа неудачных попыток входа в ИС.</td>
            <td>Команда</td>
            <td></td>
            <td></td>
            <td>samba-tool(8)<br><a href="https://docs.altlinux.org/ru-RU/domain/10.4/html/alt-domain/ch40s02s02.html">Управление парольными политиками при помощи samba-tool</a><br><a href="https://docs.altlinux.org/ru-RU/domain/10.4/html/group-policy/pso.html">Управление объектами парольных настроек</a></td>
        </tr>
    </tbody>
</table>
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            ...
            <td>Определение ограничений ресурсов системы для пользователя или групп пользователей.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>limits.conf(5)<br><a href="https://www.basealt.ru/fileadmin/user_upload/manual/LKNV.11100-01_90_03_Rukovodstvo_administratora.pdf">Руководсто администратора, п. 9.3.</a></td>
        </tr>
        <tr>
            <td>2.</td>
            <td>/lib64/security/pam_limits.so</td>
            <td>Модуль PAM для определения ограничений ресурсов системы.</td>
            <td>Модуль PAM.</td>
            <td></td>
            <td></td>
            <td>pam_limits(8)</td>
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            <td>1.</td>
            <td>/usr/bin/vlock</td>
            <td>Интерфейс блокировки терминала.</td>
            <td>Команда.</td>
            <td>УПД.10</td>
            <td>УБИ.119</td>
            <td>vlock(1)</td>
        ...
        <tr>
            <td>2.</td>
            <td>/usr/bin/tmux<br>/usr/bin/screen</td>
            <td>Интерфейс мультиплексора терминала.</td>
            <td>Команды.</td>
            <td>УПД.10</td>
            <td>УБИ.119</td>
            <td>tmux(1)<br>screen(1)</td>
        </tr>
        <tr>
            <td>3.</td>
            <td>/etc/tmux.conf<br>/etc/screenrc<br>/etc/bashrc.d/*.sh</td>
            <td>Интерфейсы принудительного запуска vlock при достижении тайм-аута блокировки.</td>
            <td>Конфигурационные файлы.</td>
            <td>УПД.10</td>
            <td>УБИ.119</td>
            <td>tmux(1)<br>screen(1)<br>bash(1)</td>
        </tr>
        <tr>
            <td>4.</td>
            <td>/usr/bin/gpui-main</td>
            <td>Позволяет централизованно задать и принудительно применить настройки для пользователей домена в Linux через механизм gpui.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>gpui(1)<br><a href="https://www.basealt.ru/fileadmin/user_upload/manual/ALT_Domain_guide.pdf">Руководство администратора, п. 3.6.2</a></td>
        </tr>
        <tr>
            <td>5.</td>
            <td>/etc/openssh/sshd_config</td>
            <td>Позволяет настроить блокировку ssh-сеанса при помощи полей ClientAliveInterval и ClientAliceCountMax.</td>
            <td>Конфигурационные файлы.</td>
            <td></td>
            <td></td>
            <td>sshd_config(5)</td>
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            <td>1.</td>
            <td>/etc/lightdm/lightdm.conf</td>
            <td>Позволяет определить действия пользователей, разрешённые до прохождения идентификации и аутентификации в lightdm.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td><a href="https://www.basealt.ru/fileadmin/user_upload/manual/LKNV.11100-01_99_03_Rukovodstvo_po_kompleksu_sredstv_zashchity.pdf">3.2.10. Разрешение (запрет) действий пользователей, разрешенных до идентификации и аутентификации</a></td>
        </tr>
        <tr>
            <td>2.</td>
            <td>/usr/bin/gpui-main</td>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td>login(1)<br><a href="https://www.basealt.ru/fileadmin/user_upload/manual/ALT_Domain_guide.pdf">3.6.5.3.6 Ограничения службы Login</a></td>
        </tr>
    </tbody>
</table>
...
**УПД.14 Регламентация и контроль использования в информационной системе технологий беспроводного доступа<br>(мера обязательна для К1, К2 и К3)**

***Требования для реализации меры:***

В соответствии с [Методическим документом ФСТЭК "Меры защиты информации в государственных информационных системах" от 11.02.2014 (п. 3.2., стр. 40)](https://fstec.ru/dokumenty/vse-dokumenty/spetsialnye-normativnye-dokumenty/metodicheskij-dokument-ot-11-fevralya-2014-g) оператором должны обеспечиваться регламентация и контроль использования в информационной системе технологий беспроводного доступа пользователей к объектам доступа (стандарты коротковолновой радиосвязи, спутниковой и пакетной радиосвязи), направленные на защиту информации в информационной системе.

Правила и процедуры применения технологий беспроводного доступа должны быть описаны в организационно-распорядительных документах по защите информации у заказчика.

Требование может быть реализовано с применением систем контроля действий привилегированных учётных записей <code>PAM</code> (<b>нужно уточнить</b>).<br>
Также требование может быть реализовано при помощи правил Polkit, связанных, например, с NetworkManager (Wi-Fi, Blooetoth).

Данная мера технически реализуется программно-аппаратными средствами типа VipNet, Континент и т.д. ОС должны быть совместимы с этими средствами.

**УПД.15 Регламентация и контроль использования в информационной системе мобильных технических средств<br>(мера обязательна для К1, К2 и К3)**

***Требования для реализации меры:***

В соответствии с [Методическим документом ФСТЭК "Меры защиты информации в государственных информационных системах" от 11.02.2014 (п. 3.2., стр. 42)](https://fstec.ru/dokumenty/vse-dokumenty/spetsialnye-normativnye-dokumenty/metodicheskij-dokument-ot-11-fevralya-2014-g) для данной меры определяются следующие технические требования:
1. Мониторинг и контроль применения мобильных технических средств на предмет выявления несанкционированного использования мобильных технических средств для доступа к объектам доступа ИС.
2. Возможность запрета возможности запуска без команды пользователя в ИС ПО, используемого для взаимодействия с мобильным техническим средством.

Мобильными техническими средствами являются съёмные машинные носители информации (флэш-накопители, внешние накопители на жёстких дисках, иные устройства), портативные вычислительные устройства и устройства связи с возможностью обработки информации (ноутбуки, нетбуки, планшеты, сотовые телефоны, цифровые камеры, звукозаписывающие устройства и иные устройства).

Правила и процедуры применения мобильных технических средств должны быть описаны в организационно-распорядительных документах по защите информации у заказчика.
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            <td>1.</td>
            <td>/etc/udev/rules.d/*.rules</td>
            <td>Блокировка или разрешение конкретных устройств по VID (Vendor-ID)/PID.</td>
            <td>Конфигурационные файлы.</td>
            <td></td>
            <td></td>
            <td>udev(7)</td>
        ...
        <tr>
            <td>2.</td>
            <td>/sys/bus/usb/devices/*/autorized</td>
            <td>Динамическое отключение конкретного USB-порта.</td>
            <td>Системный файл устройств.<br>Конфигурационные файлы.</td>
            <td></td>
            <td></td>
            <td>usb-devices(1)</td>
        </tr>
        <tr>
            <td>3.</td>
            <td>/usr/bin/lsusb<br>/usr/bin/usbguard</td>
            <td>Просмотр подключённых USB-устройств.</td>
            <td>Команды.<br>Демон.</td>
            <td></td>
            <td></td>
            <td>lsusb(8)<br><a href="https://www.altlinux.org/USBGuard">Alt Wiki: USBGuard</a></td>
        </tr>
        <tr>
            <td>4.</td>
            <td>/etc/usbguard/rules.conf</td>
            <td>Политики доступа к USB-устройствам с поддержкой криптоподписи.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td><a href="https://www.altlinux.org/USBGuard">Alt Wiki: USBGuard</a></td>
        ...
        <tr>
            <td>5.</td>
            <td>/etc/polkit-1/rules.d/*</td>
            <td>Контроль прав доступа к операциям с устройствами (например, монтирование).</td>
            <td>Polkit правила на JS.</td>
            <td></td>
            <td></td>
            <td>polkit(8)</td>
        </tr>
        <tr>
            <td>6.</td>
            <td>/etc/fstab<br>Значение полей: noauto,user</td>
            <td>Запрет автоматического монтирования съёмных носителей.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>fstab(5)</td>
        ...
        <tr>
            <td>7.</td>
            <td>/etc/udisks2/*.conf</td>
            <td>Тонкая настройка политик монтирования через udisks</td>
            <td>Конфигурационные файлы.</td>
            <td></td>
            <td></td>
            <td>udisks2.conf(5)</td>
        </tr>
        <tr>
            <td>8.</td>
            <td>/etc/samba/smb.conf<br>Параметр: veto files</td>
            <td>Блокировка исполняемых файлов на сетевых ресурсах.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>smb.conf(5)</td>
        ...
        <tr>
            <td>9.</td>
            <td>/etc/pam.d/system-auth<br>Библиотека: pam_usb.so</td>
            <td>Аутентификация по USB-токенам.</td>
            <td>PAM-модуль.</td>
            <td></td>
            <td></td>
            <td>pam_systemd(8)</td>
        ...
        <tr>
            <td>10.</td>
            <td>/etc/audit/rules.d/usb.rules</td>
            <td>Логирование операций с USB-устройствами.</td>
            <td>Правила auditd.</td>
            <td></td>
            <td></td>
            <td>auditd(8)</td>
        </tr>
        <tr>
            <td>11.</td>
            <td>/sbin/cryptsetup luksFormat</td>
            <td>Шифрование съёмных носителей.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>cryptsetup(8)</td>
        ...
        <tr>
            <td>12.</td>
            <td>/etc/security/namespace.conf</td>
            <td>Изоляция пользовательских сессий для съёмных носителей.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td>namespace.conf(5)</td>
        </tr>
        <tr>
            <td>13.</td>
            <td>/usr/sbin/semanage fcontext</td>
            <td>Настройка SELinux-контекста для съёмных устройств.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>semanage(8)<br>semanage.conf(5)</td>
        </tr>
        <tr>
            <td>14.</td>
            <td>/usr/bin/ipa hbacrule-add</td>
            <td>Централизованное управление доступом в домене.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td>ipa(1)</td>
...
**УПД.16 Управление взаимодействием с информационными системами сторонних организаций (внешние информационные системы)<br>(мера обязательна для К1, К2 и К3)**

***Требования для реализации меры:***

В соответствии с [Методическим документом ФСТЭК "Меры защиты информации в государственных информационных системах" от 11.02.2014 (п. 3.2., стр. 44)](https://fstec.ru/dokumenty/vse-dokumenty/spetsialnye-normativnye-dokumenty/metodicheskij-dokument-ot-11-fevralya-2014-g) оператором должно быть обеспечено управление взаимодействием с внешними ИС.

Управление взаимодействием должно включать:
* предоставление доступа к ИС только уполномоченным пользователям в соответствии с УПД.2;
* определение типов прикладного ПО ИС, к которым разрешён доступ уполномоченным пользователям из внешних ИС;
* определение системных учётных записей, используемых в рамках данного взаимодействия;
* определение порядка предоставления доступа к ИС уполномоченными пользователями из внешних ИС;
* определение порядка обработки, хранения и передачи информации с использованием внешних факторов ИС.

Правила и процедуры управления взаимодействием с внешними ИС должны быть описаны в организационно-распорядительных документах по защите информации у заказчика.

Для контроля доступа из внешних ИС должны использоваться сертифицированные МЭ (Netfilter не является сертифицированным). ОС должна быть совместима с программными и программно-аппаратными МЭ.

**УПД.17 Обеспечение доверенной загрузки средств вычислительной техники<br>(мера обязательна для К1 и К2)**

***Требования для реализации меры:***

В соответствии с [Методическим документом ФСТЭК "Меры защиты информации в государственных информационных системах" от 11.02.2014 (п. 3.2., стр. 45)](https://fstec.ru/dokumenty/vse-dokumenty/spetsialnye-normativnye-dokumenty/metodicheskij-dokument-ot-11-fevralya-2014-g) оператором должно быть обеспечено исключение несанкционированного доступа к программным или техническим ресурсам средства вычислительной техники информационной системы на этапе его загрузки.

Доверенная загрузка должна обеспечивать:
* блокирование попыток несанкционированной загрузки нештатной операционной системы (сторонней, которая не определена в документах) или недоступность информационных ресурсов для чтения или модификации в случае загрузки нештатной операционной системы;
...
В информационной системе применяется доверенная загрузка на разных уровнях (уровень BIOS, уровень платы расширения и уровень загрузочной записи).

Правила и процедуры обеспечения доверенной загрузки СВТ должны быть описаны в организационно-распорядительных документах по защите информации у заказчика.
...
<table>
    ...
    <tbody style="font-size: 12px;">
        <tr>
            <td>1.</td>
            <td>/etc/grub.d/40_custom</td>
            <td>Настройка GRUB: добавление пароля и пользовательских записей загрузки.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>2.</td>
            <td>/usr/bin/grub-mkpasswd-pbkdf2</td>
            <td>Создание зашифрованного пароля GRUB (PBKDF2 hash).</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td>Генерация основного загрузочного меню GRUB.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>4.</td>
            <td>/usr/sbin/grub-mkconfig</td>
            <td>Команда генерации grub.cfg из шаблонов.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>5.</td>
            <td>BIOS/UEFI Setup</td>
            <td>Отключение загрузки с USB/сетевых устройств, установка пароля.</td>
            <td>Настройка микропрограммы.</td>
            <td></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            <td>6.</td>
            <td>Secure Boot</td>
            <td>Запрет запуска неподписанных загрузчиков через UEFI.</td>
            <td>UEFI-функция.</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>7.</td>
            <td>/sbin/cryptsetup</td>
            <td>Настройка шифрования LUKS на дисках.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>8.</td>
            <td>/usr/sbin/aide</td>
            <td>Инструмент обнаружения вторжений с механизмом проверки целостности системных файлов.</td>
            <td>Команда.</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>9.</td>
            <td>/etc/aide.conf</td>
            <td>Конфигурация для AIDE: какие файлы проверять.</td>
            <td>Конфигурационный файл.</td>
            <td></td>
            <td></td>
            <td></td>
        ...
        <tr>
            <td>10.</td>
            <td>initrd + dracut</td>
            <td>Ранняя загрузка и подготовка системы: монтирование LUKS, проверка rootfs.</td>
            <td>Механизм загрузки ОС.</td>
            <td></td>
            <td></td>
            <td></td>
        </tr>
        <tr>
            <td>11.</td>
            <td>IMA/EVM</td>
            <td>Контроль целостности файлов ядра и исполняемых файлов в ранней загрузке.</td>
            <td>Ядро и политики.</td>
            <td></td>
            <td></td>
            <td></td>
        </tr>
...
**ОПС.1 Управление запуском (обращениями) компонентов программного обеспечения, в том числе определение запускаемых компонентов, настройка параметров запуска компонентов, контроль за запуском компонентов программного обеспечения<br>(мера обязательна для К1)**

***Требования для реализации меры:***

В соответствии с [Методическим документом ФСТЭК "Меры защиты информации в государственных информационных системах" от 11.02.2014 (п. 3.3., стр. 47)](https://fstec.ru/dokumenty/vse-dokumenty/spetsialnye-normativnye-dokumenty/metodicheskij-dokument-ot-11-fevralya-2014-g) для данной меры определяются следующие технические требования:
1. разрешение запуска компонентов ПО, включённых в список ПО, запускаемого автоматически при загрузке ОС;
2. ограничение запуска компонентов ПО от имени администраторов безопасности (например, разрешение такого запуска только для определённого ПО: сенсоры систем обнаружения вторжений, агенты систем мониторинга событий информационной безопасности, средства антивирусной защиты);
3. настройка параметров запуска компонентов ПО от имени учётной записи администратора безопасности таким образом, чтобы текущий пользователь не мог получить через данные компоненты доступ к объектам доступа, на доступ к которым у него нет прав в соответствии с УПД.2;
4. контроль за запуском компонентов ПО, обеспечивающий выявление компонентов ПО, не включённых в список компонентов, запускаемых автоматически при загрузке ОС.

Оператор должен определить список компонентов ПО (файлов, объектов баз данных, хранимых процедур и иных компонентов), запускаемых автоматически при загрузке ОС.

Правила и процедуры управления запуском ПО должны быть описаны в организационно-распорядительных документах по защите информации у заказчика.

Мера относится к механизму замкнутой программной среды, которую частично может реализовать подсистема IMA/EVM [Руководство по КСЗ, п. 2.3.7.2. Подсистема IMA/EVM](https://www.basealt.ru/fileadmin/user_upload/manual/LKNV.11100-01_99_03_Rukovodstvo_po_kompleksu_sredstv_zashchity.pdf).
